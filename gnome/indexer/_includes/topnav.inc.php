...
<?php if (str_contains($_SERVER["REQUEST_URI"], 'gnome')) : ?>
  <script>
    function logout() {
      window.location = '/gnome/az_logout.php';
    }
  </script>
<?php endif; ?>
...
*/
      ...
      <li class="nav-item dropdown pe-3">
        ...
        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
          ...
          <?php if (str_contains($_SERVER["REQUEST_URI"], 'gnome')) : ?>
            <li>
              <a href="javascript:;" onclick="logout()" class="dropdown-item d-flex align-items-center">
