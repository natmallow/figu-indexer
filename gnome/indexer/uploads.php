...
<body class="">
    ...
    <?php include __DIR__ . '/../includes/title.inc.php'; ?>
        ...
        <section class="section">
            ...
            <!-- <div>
                <div class="box alt" id='container-image' style="height: 45vh; overflow-y:auto; position:relative; z-index:10000">
...
<div class="modal fade" id="container-image" tabindex="-1" aria-labelledby="modalTitle" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <!-- Modal Header -->
      <div class="modal-header">
        <h5 class="modal-title" id="modalTitle">Modal Title</h5>
        <button type="button" class="btn-close rst" id="closeModal" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <!-- Modal Body (content will be loaded here) -->
      <div class="modal-body" id="container-dir" style="height: 45vh; overflow-y:auto; position:relative; z-index:10000">
