...
<body class="">
        ...
        <section class="section">
            ...
            <div class="row mb-3">
                <div class="col-md-12 d-flex justify-content-between align-items-center">
                    ...
                    <a href="/gnome/indexer/users.php?action=add" class="btn btn-primary btn-sm">Create New</a>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
            ...
            <?php if (!empty($_GET['action']) && ($_GET['action'] == 'edit' || $_GET['action'] == 'add')) : ?>
                ...
                <form id="sectionForm" method="POST" class="row g-3" action="users.php" onsubmit="return runSubmit()">
                    ...
                    <div class="col-12 d-flex justify-content-between">
                        <a href="/gnome/indexer/users.php" class="btn btn-secondary">Cancel</a>
    ...
    <script>
        function runActivate(username) {
            ...
            var fetchPromise = fetch(`/gnome/indexer/user.php?username=${username}&action=activate`);
        ...
        function runDelete(username) {
            ...
            d.style.display = 'none';
            var fetchPromise = fetch(`/gnome/indexer/user.php?username=${username}&action=deleteUser`);
            fetchPromise.then(response => {
                return response.json();
            }).then(data => {
                // console.log(data);
